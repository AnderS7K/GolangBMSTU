...
export function ManagerNavbar() {
    const navigation = [
        {name: 'Пицца', href: '/pizzas'},
        {name: 'Корзина', href: '/cart'},
        {name: 'Ваши заказы', href: '/user_orders'},
        {name: 'О нас', href: '/info'},
        {name: 'Добавить пиццу', href: '/add'},
                        ...
                        <div className="relative flex h-16 items-center justify-between">
                                            ...
                                            <NavLink
                                                ...
                                                className={({isActive}) =>
                                                    [
                                                        ...
                                                        isActive ? "bg-stone-900 text-white" : "text-stone-300 hover:bg-stone-700 hover:text-white",
                                                    ]
                                                        .filter(Boolean)
                                                        .join(" ")
                                                }
                            ...
                            <div
                                ...
                                <Menu as="div" className="relative ml-3">
                                    <div>
                                        <Menu.Button
                                            className="flex rounded-full bg-stone-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-stone-800">
